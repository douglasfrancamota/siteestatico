...
export default function Irlanda(){
    return(
        <div>
            <Header title='Irlanda'/>


                <main>
                    <article class="recipe-body">
                        <h1 className="Recipe-body-name">Irlanda</h1>
                            <img className="recipe-body-picture" alt="Irlanda" src= "https://www.asseguresuaviagem.com/images/Viagem-para-Irlanda.jpg" />    
                            <div>
